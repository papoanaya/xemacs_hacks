...
(custom-autoload 'jabber-account-list "jabber")

(defvar jabber-default-show "" "\
default show state")

(custom-autoload 'jabber-default-show "jabber")

(defvar jabber-default-status "" "\
default status string")

(custom-autoload 'jabber-default-status "jabber")

(defvar jabber-default-priority 10 "\
default priority")

(custom-autoload 'jabber-default-priority "jabber")
...
(custom-autoload 'jabber-debug-log-xml "jabber")
...
(custom-autoload 'jabber-debug-keep-process-buffers "jabber")
...
(custom-autoload 'jabber-activity-mode "jabber-activity" )
...
(custom-autoload 'jabber-keepalive-interval "jabber-keepalive")

(defvar jabber-keepalive-timeout 20 "\
Seconds to wait for response from server.")

(custom-autoload 'jabber-keepalive-timeout "jabber-keepalive")
...
(custom-autoload 'jabber-whitespace-ping-interval "jabber-keepalive")
...
(custom-autoload 'jabber-display-menu "jabber-menu")
...
(custom-autoload 'jabber-muc-default-nicknames "jabber-muc")
...
(custom-autoload 'jabber-muc-autojoin "jabber-muc")
